							...
							<div className="row">
								<div className="col-md-12 nav-link-wrap mb-5">
									<div className="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
										<a className="nav-link active" id="v-pills-1-tab" onClick={() => { handelClick(`Men's Clothing`) }}>Men's Clothing</a>

										<a className="nav-link" id="v-pills-2-tab" onClick={() => { handelClick('Jewelery') }}>Jewelery</a>

										<a className="nav-link" id="v-pills-3-tab" onClick={() => { handelClick('Electronics') }}>Electronics</a>

										<a className="nav-link" id="v-pills-4-tab" onClick={() => { handelClick(`Women's Clothing`) }}>Women's Clothing</a>
									</div>
								</div>
