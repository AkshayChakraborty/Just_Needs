                ...
                <div className="row">
                    <div className="col-md-2">
                        <div className="filter-div">
                            <ul>
                                <li><button onClick={() => { handelClick(`Men's Clothing`) }}>Men's Clothing</button></li>
                                <li><button onClick={() => { handelClick('Jewelery') }}>Jewelery</button></li>
                                <li><button onClick={() => { handelClick('Electronics') }}>Electronics</button></li>
                                <li><button onClick={() => { handelClick(`Women's Clothing`) }}>Women's Clothing</button></li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-10">
                        <h1 className="fw-bold text-center">Our All Product</h1>
                        <div className="row">
                            {
                                data === null ?
                                    <>
