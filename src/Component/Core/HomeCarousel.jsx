                                                ...
                                                <div className="row slider-text align-items-center" data-scrollax-parent="true">
                                                    ...
                                                    <div className="col-md-6 col-sm-12 ftco-animate">
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <Link to="/menu" className="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3 ms-4">View Product</Link>
                                                        </div>
                                                    </div>
                            ...
                            <div className="container">
                                <div className="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                                    ...
                                    <div className="col-md-7 col-sm-12 text-center ftco-animate">
                                        ...
                                        <h1 className="mb-4">Technology that grows with your online business</h1>
                                        ...
                                        <div className="d-flex justify-content-center">
                                            ...
                                            <a href="#" className="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3 ms-4">View Product</a>
                                        </div>
                                    </div>
